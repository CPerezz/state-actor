...
//   - --fork=merge ceiling (writer builds a pre-Shanghai header)
//   - inline boot.cfg with Mining.Enabled=true
...
func TestE2ESuite(t *testing.T) {
	...
	// Pin --fork=merge (nethermind's MaxForkForClient ceiling). 60M gas
