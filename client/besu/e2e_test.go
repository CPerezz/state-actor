...
func TestE2ESuite(t *testing.T) {
	...
	// Pin --fork=shanghai (besu's MaxForkForClient ceiling). 60M gas
	// matches mainnet-current.
	...
	// script). --miner-enabled + --miner-coinbase + --min-gas-price=0
	// are required for besu 25.11.0 to accept the chainspec's
	// ethash.fixeddifficulty stanza.
